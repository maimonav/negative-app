...
async function updateEmployee() {
  ...
  await DB.singleUpdate(
    "employee",
    { id: 1 },
    { firstName: "Noam", lastName: "Chen", contactDetails: "0500000000" }
  );
  await DB.singleGetById("employee", { id: 1 }).then((result) => {
    expect(result.id).toBe(1);
