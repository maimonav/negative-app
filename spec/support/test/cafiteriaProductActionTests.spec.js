describe("cafitriaProductActionTest", () => {
    ...
    it("UnitTest-InventoryManagement addCafeteriaProduct", async() => {
        ...
        ).toEqual("Category doesn't exist");
        expect(
            await inventoryManagement.addCafeteriaProduct(
                p1.id,
                p1.name,
        ...
        ).toEqual("Product price must be greater than 0");
        expect(
            await inventoryManagement.addCafeteriaProduct(
                p1.id,
                p1.name,
        ...
        ).toEqual("Product quantity must be greater or equal to 0");
        expect(
            await inventoryManagement.addCafeteriaProduct(
                p1.id,
                p1.name,
        ...
        ).toEqual("The product was successfully added to the system");
        expect(
            await inventoryManagement.addCafeteriaProduct(
                p1.id,
                p1.name,
        ...
        ).toEqual("This product already exists");
    });
    ...
    it("UnitTest-InventoryManagement editCafeteriaProduct", async() => {
        ...
        expect(
            await inventoryManagement.editCafeteriaProduct(
                p1.id - 1,
                p1.name,
                p1.categoryId,
                p1.price,
        ...
        ).toEqual("This product not exists");
        expect(
            await inventoryManagement.editCafeteriaProduct(
                p1.id,
                p1.name,
    ...
    it("UnitTest-InventoryManagement removeCafeteriaProduct", async() => {
        ...
        expect(await inventoryManagement.removeCafeteriaProduct(p1.id - 1)).toEqual(
            "This product not exists"
        );
        expect(await inventoryManagement.removeCafeteriaProduct(p1.id)).toEqual(
            "dummy"
        ); //in the integration need to add more line like this
    });
    ...
    it("UnitTest-cinemaSystem- addCafeteriaProduct", async() => {
        ...
        ).toEqual(cinemaSystem.inappropriatePermissionsMsg);
    ...
    it("UnitTest-cinemaSystem- removeCafeteriaProduct", async() => {
        spyOn(inventoryManagement, "removeCafeteriaProduct").and.returnValue(
            "dummy"
        );
    ...
    it("UnitTest-ServiceLayer- addNewProduct", async() => {
        ...
        ).toEqual("Product name is not valid");
        expect(
            await serviceLayer.addNewProduct(
                p1.name,
                "",
        ...
        ).toEqual("Product price is not valid");
        expect(
            await serviceLayer.addNewProduct(
                p1.name,
                p1.price,
        ...
        ).toEqual("Product quantity is not valid");
        expect(
            await serviceLayer.addNewProduct(
                p1.name,
                p1.price,
        ...
        ).toEqual("Product category is not valid");
        expect(
            await serviceLayer.addNewProduct(
                p1.name,
                p1.price,
        ...
        ).toEqual("Product category does not exist");
        expect(
            await serviceLayer.addNewProduct(
                p1.name,
                p1.price,
    ...
    it("UnitTest-ServiceLayer- editProduct", async() => {
        ...
        ).toEqual("The product doesn't exist");
        expect(
            await serviceLayer.editProduct(
                p1.name,
                p1.price,
    ...
    it("UnitTest-ServiceLayer- removeProduct", async() => {
        ...
        expect(await serviceLayer.removeProduct("dummy", admin.userName)).toEqual(
            "The product does not exist"
        );
        expect(await serviceLayer.removeProduct(p1.name, admin.userName)).toEqual(
            "dummy"
        );
    });
    ...
    it("Integration-ServiceLayer- editProduct", async() => {
        ...
        expect(p1.price).toEqual(price);
        expect(p1.quantity).toEqual(1234);
        expect(p1.minQuantity).toEqual(minQuantity);
        expect(p1.maxQuantity).toEqual(maxQuantity);
    });
