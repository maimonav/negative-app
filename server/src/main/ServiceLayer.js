...
class ServiceLayer {
    ...
    async addNewEmployee(userName, password, firstName, lastName, permissions, contactDetails, ActionIDofTheOperation) {
        ...
        let result = await this.cinemaSystem.addNewEmployee(this.userCounter, userName, password,
            permissions, firstName, lastName, contactDetails,
    ...
    async editEmployee(userName, password, permissions, firstName, lastName, contactDetails, ActionIDOfTheOperation) {
        if (!this.users.has(userName)) {
        ...
        if (!this.users.has(ActionIDOfTheOperation)) {
            logger.info("ServiceLayer - The editEmployee process failed - the " + ActionIDOfTheOperation +
                " , who initiated the operation, does not exist in the system");
            return "The user performing the operation does not exist in the system";
        }
        return await this.cinemaSystem.editEmployee(this.users.get(userName), password, permissions, firstName, lastName, contactDetails, this.users.get(ActionIDOfTheOperation));
    }
