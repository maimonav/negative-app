...
class ServiceLayer {
    ...
    async editOrder(orderName, dateSTR, supplierName, productsList, ActionIDOfTheOperation) {
        ...
        productsList.forEach((product) => {
            ...
            if (typeof product.actualQuantity !== 'undefined' && (isNaN(product.actualQuantity) && typeof(product.actualQuantity) !== 'number')) {
                logger.info(
                    "ServiceLayer- editOrder - The product " +
                    product.name +
        ...
        if (typeof problematicQuantityName !== "undefined")
            return "The product " + product.name + "'s quantity received is not a number type";
    ...
    async confirmOrder(orderName, productsList, ActionIDOfTheOperation) {
            ...
            if (typeof problemticProductName !== "undefined")
                return "The product " + problemticProductName + " doesn't exists";
            if (typeof problematicQuantityName !== "undefined")
                return "The product " + problematicQuantityName + "'s quantity received is not a number type"
            if (!this.users.has(ActionIDOfTheOperation)) {
                logger.info(
