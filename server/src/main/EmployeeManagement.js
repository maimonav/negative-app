...
class EmployeeManagemnt {
    ...
    async addNewEmployee(userID, userName, password, permissions, firstName, lastName, contactDetails) {
    ...
    async editEmployee(employeeID, password, permissions, firstName, lastName, contactDetails) {
        ...
        return await this.employeeDictionary.get(employeeID).editEmployee(password, permissions, firstName, lastName, contactDetails);
    }
