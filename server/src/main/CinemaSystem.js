...
class CinemaSystem {
    ...
    async addCafeteriaProduct(
            ...
            if (isNaN(price) && typeof price !== 'number') {
                logger.info('addNewProduct - add new product fail - Product price must be number ');
                return 'Add new product fail - Product price ' + price + ' must be number '
            }
            if (isNaN(quantity) && typeof quantity !== 'number') {
                logger.info('addNewProduct - add new product fail - Product quantity must be number ');
                return 'Add new product fail - Product quantity must be number '
            }
            if ((isNaN(minQuantity) && typeof minQuantity !== 'number') || (typeof minQuantity === 'undefined')) {
                logger.info('addNewProduct - add new product fail - Product minQuantity must be number ');
                return 'Add new product fail - Product minQuantity must be number '
            }
            if ((isNaN(maxQuantity) && typeof maxQuantity !== 'number') || (typeof maxQuantity === 'undefined')) {
                logger.info('addNewProduct - add new product fail - Product maxQuantity must be number ');
